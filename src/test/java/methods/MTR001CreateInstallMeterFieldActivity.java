...
public class MTR001CreateInstallMeterFieldActivity extends AbstractTestNGCucumberTests {
    private static final Logger LOGGER = LoggerFactory.getLogger(MTR001CreateInstallMeterFieldActivity.class);
