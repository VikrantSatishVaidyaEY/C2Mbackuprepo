...
public class CI011AddPremiseToExistingLandlordAgreement extends AbstractTestNGCucumberTests {
    private static final Logger LOGGER = LoggerFactory.getLogger(CI011AddPremiseToExistingLandlordAgreement.class);
