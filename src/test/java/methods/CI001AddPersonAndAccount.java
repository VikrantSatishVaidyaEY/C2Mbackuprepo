...
public class CI001AddPersonAndAccount extends AbstractTestNGCucumberTests {
    private static final Logger LOGGER = LoggerFactory.getLogger(CI001AddPersonAndAccount.class);
