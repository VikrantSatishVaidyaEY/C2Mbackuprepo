...
public class DM005CreateAssetGasDeviceTypeXXXEquipment extends AbstractTestNGCucumberTests {
    private static final Logger LOGGER = LoggerFactory.getLogger(DM005CreateAssetGasDeviceTypeXXXEquipment.class);
