...
public class CC012ModifyingCollectionEventTriggerDate extends AbstractTestNGCucumberTests {
    private static final Logger LOGGER = LoggerFactory.getLogger(CC012ModifyingCollectionEventTriggerDate.class);
