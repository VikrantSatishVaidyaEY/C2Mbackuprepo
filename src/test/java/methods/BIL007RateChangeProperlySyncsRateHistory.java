...
public class BIL007RateChangeProperlySyncsRateHistory extends AbstractTestNGCucumberTests {
    private static final Logger LOGGER = LoggerFactory.getLogger(BIL007RateChangeProperlySyncsRateHistory.class);
