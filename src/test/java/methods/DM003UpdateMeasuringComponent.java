...
public class DM003UpdateMeasuringComponent extends AbstractTestNGCucumberTests {
    private static final Logger LOGGER = LoggerFactory.getLogger(DM003UpdateMeasuringComponent.class);
