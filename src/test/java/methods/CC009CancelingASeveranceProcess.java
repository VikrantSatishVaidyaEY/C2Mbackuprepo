...
public class CC009CancelingASeveranceProcess extends AbstractTestNGCucumberTests {
    private static final Logger LOGGER = LoggerFactory.getLogger(CC009CancelingASeveranceProcess.class);
