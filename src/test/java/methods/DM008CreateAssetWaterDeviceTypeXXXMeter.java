...
public class DM008CreateAssetWaterDeviceTypeXXXMeter extends AbstractTestNGCucumberTests {
    private static final Logger LOGGER = LoggerFactory.getLogger(DM008CreateAssetWaterDeviceTypeXXXMeter.class);
