...
public class CC007AddingAWriteOffProcess extends AbstractTestNGCucumberTests {
    private static final Logger LOGGER = LoggerFactory.getLogger(CC007AddingAWriteOffProcess.class);
