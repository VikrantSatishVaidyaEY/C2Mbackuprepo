...
public class CC010CancellingAWriteOffProcess extends AbstractTestNGCucumberTests {
    private static final Logger LOGGER = LoggerFactory.getLogger(CC010CancellingAWriteOffProcess.class);
