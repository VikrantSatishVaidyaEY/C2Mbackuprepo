...
public class DM004CreateAssetGasDeviceTypeXXXMeter extends AbstractTestNGCucumberTests {
    private static final Logger LOGGER = LoggerFactory.getLogger(DM004CreateAssetGasDeviceTypeXXXMeter.class);
