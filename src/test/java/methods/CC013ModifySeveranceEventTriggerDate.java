...
public class CC013ModifySeveranceEventTriggerDate extends AbstractTestNGCucumberTests {
    private static final Logger LOGGER = LoggerFactory.getLogger(CC013ModifySeveranceEventTriggerDate.class);
