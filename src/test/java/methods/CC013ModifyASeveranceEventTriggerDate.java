...
public class CC013ModifyASeveranceEventTriggerDate extends AbstractTestNGCucumberTests {
    private static final Logger LOGGER = LoggerFactory.getLogger(CC013ModifyASeveranceEventTriggerDate.class);
