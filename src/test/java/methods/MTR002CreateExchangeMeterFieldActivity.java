...
public class MTR002CreateExchangeMeterFieldActivity extends AbstractTestNGCucumberTests {
    private static final Logger LOGGER = LoggerFactory.getLogger(MTR002CreateExchangeMeterFieldActivity.class);
