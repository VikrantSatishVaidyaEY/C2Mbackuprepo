...
public class FIN008SettingUpAutopay extends AbstractTestNGCucumberTests {
    private static final Logger LOGGER = LoggerFactory.getLogger(FIN008SettingUpAutopay.class);
