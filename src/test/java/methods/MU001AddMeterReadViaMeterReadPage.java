...
public class MU001AddMeterReadViaMeterReadPage extends AbstractTestNGCucumberTests {
    private static final Logger LOGGER = LoggerFactory.getLogger(MU001AddMeterReadViaMeterReadPage.class);
