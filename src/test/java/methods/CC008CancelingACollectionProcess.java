...
public class CC008CancelingACollectionProcess extends AbstractTestNGCucumberTests {
    private static final Logger LOGGER = LoggerFactory.getLogger(CC008CancelingACollectionProcess.class);
