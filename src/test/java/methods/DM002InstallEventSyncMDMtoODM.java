...
public class DM002InstallEventSyncMDMtoODM extends AbstractTestNGCucumberTests {
    private static final Logger LOGGER = LoggerFactory.getLogger(DM002InstallEventSyncMDMtoODM.class);
