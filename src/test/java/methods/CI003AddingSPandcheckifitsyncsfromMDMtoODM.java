...
public class CI003AddingSPandcheckifitsyncsfromMDMtoODM extends AbstractTestNGCucumberTests {
    private static final Logger LOGGER = LoggerFactory.getLogger(CI003AddingSPandcheckifitsyncsfromMDMtoODM.class);
