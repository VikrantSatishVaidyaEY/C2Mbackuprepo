...
public class DM006CreateAssetElectricDeviceTypeXXXMeter extends AbstractTestNGCucumberTests {
    private static final Logger LOGGER = LoggerFactory.getLogger(DM006CreateAssetElectricDeviceTypeXXXMeter.class);
