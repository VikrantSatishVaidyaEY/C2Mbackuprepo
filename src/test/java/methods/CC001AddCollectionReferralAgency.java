...
public class CC001AddCollectionReferralAgency extends AbstractTestNGCucumberTests {
    private static final Logger LOGGER = LoggerFactory.getLogger(CC001AddCollectionReferralAgency.class);
