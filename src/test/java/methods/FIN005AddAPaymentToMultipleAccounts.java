...
public class FIN005AddAPaymentToMultipleAccounts extends AbstractTestNGCucumberTests {
    private static final Logger LOGGER = LoggerFactory.getLogger(FIN005AddAPaymentToMultipleAccounts.class);
