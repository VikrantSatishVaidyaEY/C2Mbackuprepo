...
public class CC004AddingAPaymentArrangementRequest extends AbstractTestNGCucumberTests {
    private static final Logger LOGGER = LoggerFactory.getLogger(CC004AddingAPaymentArrangementRequest.class);
