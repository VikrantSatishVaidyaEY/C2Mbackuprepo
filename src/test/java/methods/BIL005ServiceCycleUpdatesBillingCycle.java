...
public class BIL005ServiceCycleUpdatesBillingCycle extends AbstractTestNGCucumberTests {
    private static final Logger LOGGER = LoggerFactory.getLogger(BIL005ServiceCycleUpdatesBillingCycle.class);
