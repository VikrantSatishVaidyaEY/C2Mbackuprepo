...
public class FIN009CancellingAutopay extends AbstractTestNGCucumberTests {
    private static final Logger LOGGER = LoggerFactory.getLogger(FIN009CancellingAutopay.class);
