...
public class MU002AddMeterReadViaMeterReadPage extends AbstractTestNGCucumberTests {
    private static final Logger LOGGER = LoggerFactory.getLogger(MU002AddMeterReadViaMeterReadPage.class);
