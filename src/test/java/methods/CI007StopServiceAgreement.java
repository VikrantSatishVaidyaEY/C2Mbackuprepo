...
public class CI007StopServiceAgreement extends AbstractTestNGCucumberTests {
    private static final Logger LOGGER = LoggerFactory.getLogger(CI007StopServiceAgreement.class);
