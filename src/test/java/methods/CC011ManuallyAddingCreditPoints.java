...
public class CC011ManuallyAddingCreditPoints extends AbstractTestNGCucumberTests {
    private static final Logger LOGGER = LoggerFactory.getLogger(CC011ManuallyAddingCreditPoints.class);
