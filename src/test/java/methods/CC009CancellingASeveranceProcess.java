...
public class CC009CancellingASeveranceProcess extends AbstractTestNGCucumberTests {
    private static final Logger LOGGER = LoggerFactory.getLogger(CC009CancellingASeveranceProcess.class);
