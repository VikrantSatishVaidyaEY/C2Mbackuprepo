...
public class CI010AddChildPremiseToParentPremise extends AbstractTestNGCucumberTests {
    private static final Logger LOGGER = LoggerFactory.getLogger(CI010AddChildPremiseToParentPremise.class);
