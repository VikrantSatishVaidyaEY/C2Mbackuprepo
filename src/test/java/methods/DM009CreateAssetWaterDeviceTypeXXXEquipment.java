...
public class DM009CreateAssetWaterDeviceTypeXXXEquipment extends AbstractTestNGCucumberTests {
    private static final Logger LOGGER = LoggerFactory.getLogger(DM009CreateAssetWaterDeviceTypeXXXEquipment.class);
