...
public class BIL006CreateHighBillComplaint extends AbstractTestNGCucumberTests {
    private static final Logger LOGGER = LoggerFactory.getLogger(BIL006CreateHighBillComplaint.class);
