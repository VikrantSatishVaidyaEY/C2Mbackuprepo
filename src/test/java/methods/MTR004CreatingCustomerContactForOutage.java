...
public class MTR004CreatingCustomerContactForOutage extends AbstractTestNGCucumberTests {
    private static final Logger LOGGER = LoggerFactory.getLogger(MTR004CreatingCustomerContactForOutage.class);
