...
public class FIN007SearchingForAPayment extends AbstractTestNGCucumberTests {
    private static final Logger LOGGER = LoggerFactory.getLogger(FIN007SearchingForAPayment.class);
