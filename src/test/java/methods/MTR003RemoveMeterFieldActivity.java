...
public class MTR003RemoveMeterFieldActivity extends AbstractTestNGCucumberTests {
    private static final Logger LOGGER = LoggerFactory.getLogger(MTR003RemoveMeterFieldActivity.class);
