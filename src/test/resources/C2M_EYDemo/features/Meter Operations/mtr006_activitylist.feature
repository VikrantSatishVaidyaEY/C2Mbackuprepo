...
#
# Date:       	by:    		Reason:
# 2023-04-27	VVaidya		Initial Version.
#####################################################################################

Feature: Create Install Meter Field Activity

  @MTR006 @regression
  Scenario Outline: Create Install Meter Field Activity
   ...
   # And I load the data for feature "MTR001"
   ...
   # And I enter "D1_SP_ID" from test data in input field fieldactivitypage.servicepoint_box
  ...
  #  And I close browser
    ...
    Examples:
     ...
     #C2MDEV |Field Activity|02-18-2022|740120333679|Install Meter|
      #C2MTEST|Field Activity|02-18-2022|794226164932|Install Meter|
      |Field Activity|10-18-2022|847347791349|Meter Installation|
      #C2MQA|Field Activity|02-18-2022|847347791349|Install Meter|