...
Feature: Validate Alert is created when Person and Premise Characteristics Updated

  @CM287 @regression
  Scenario Outline: Validate Alert is created when Person and Premise Characteristics Updated
...
#    And I close browser
    ...
    Examples:
     ...
     #C2MTEST | Account ID | 1533665862 | California | 05-03-2022 | 590 | Regular | 05-03-2022 | 05-14-2022   |
      | Account ID | 7765176386 | California | 05-03-2022 | 590 | Regular | 05-03-2022 | 05-14-2022   |
