...
#
# Date:       	by:    		Reason:
# 2022-05-02	CTongo		Initial Version.
#
#####################################################################################

Feature: Create Asset Gas Device Type XXX Equipment

  @DM005 @regression
  Scenario Outline: Create Asset Gas Device Type XXX Equipment
...
# C2MDEV
  #      | Gas AMR Battery | East Service Center Warehouse,2910 Willamette Pl  | GBAT_UNKNOWN     |
#      | Gas Correcting Instrument | East Service Center Warehouse,2910 Willamette Pl  | CI_DRESSER_MSPDL    |
#      #| Gas Communication Module | East Service Center Warehouse,2910 Willamette Pl  | CI_DRESSER_MSPDL    |
#      | Gas Communication Device | East Service Center Warehouse,2910 Willamette Pl  | GCOM_MERCURY_SENTRY    |
#



  | Gas AMR Battery | East Service Center Warehouse,2910 Willamette Pl  | GBAT_UNKNOWN     |
  | Gas Correcting Instrument | East Service Center Warehouse,2910 Willamette Pl  | CI_MERCURY_SP    |
      #| Gas Communication Module | East Service Center Warehouse,2910 Willamette Pl  | CI_DRESSER_MSPDL    |
  | Gas Communication Device | East Service Center Warehouse,2910 Willamette Pl  | GCOM_MERCURY_SENTRY    |
