Feature: Create Person with Account and Start Service Enabled
  ...
  @example
    Examples: 
      ...
      | Person             | Primary   | Clark, Jerry | Cell Phone   | (541) 160-4679 | Social security number |
      | Person             | Primary   | Lucas, George  | Cell Phone   | (328) 527-5273 | Social security number |