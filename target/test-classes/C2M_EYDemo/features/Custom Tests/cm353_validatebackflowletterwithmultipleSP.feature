...
#
# Date:       	by:    		Reason:
# 2022-08-16	AThott		Initial Version.
# 2022-08-17	VVaidya		Added Code for Datepicker and Process Flow remaining steps.
#####################################################################################

Feature: Validate Backflow Customer Contact Creation for Premise with Multiple Service point
  ...
  Scenario Outline: Validate Backflow Customer Contact Creation for Premise with Single Service point
   ...
   #working And I enter text "08-17-2022" into input field processpage.servicestartdate using javascript
    ...
    Examples:
      | searchBy  | accountId   | cisDivision                 | Premise ID | Start Date    |
      | Account ID | 8514129726 | Colorado Springs Utilities  | 6572126513 |08162022|