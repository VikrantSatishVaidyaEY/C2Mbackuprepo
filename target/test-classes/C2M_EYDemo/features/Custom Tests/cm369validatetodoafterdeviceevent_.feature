...
#
# Date:       	by:    		Reason:
# 2022-08-03	vvaidya		Initial Version.

#####################################################################################

Feature: Validate To-Do is generated after processing a device event

  @CM369 @regression
  Scenario Outline: Validate To-Do is generated after processing a device event
...
#    And I close browser
    ...
    Examples:
      ...
      |06-15-2022	|08:22:03	|Electric Type 1 - 120V 2W 1PH 100CL	|East Service Center Warehouse,2910 Willamette Pl	|1_LAN&GYR_ALF	|BN-061522082236	|SN-061522082236	|17420-E-TYPICAL	|09:22:03	|1.0|1.0|
