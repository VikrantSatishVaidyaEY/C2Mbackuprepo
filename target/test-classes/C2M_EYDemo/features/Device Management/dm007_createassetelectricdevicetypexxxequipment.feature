...
Feature: Create Asset Electric Device Type XXX Equipment

  @DM007 @regression
  Scenario Outline: Create Asset Electric Device Type XXX Equipment
...
#    And I close browser
    ...
    Examples:
      ...
      | Cable Arrester | East Service Center Warehouse,2910 Willamette Pl  | CA_UNKNOWN     |